    ...
    setup: {
        controls: (event) => {
            ...
            switch (event) {
                ...
                case "bRelease":
                    state = LCD.state;
                    value = state.setup.options[LCD.state.setup.selection].value + 1;
                ...
                case "bHold":
                    state = LCD.state;
                    options = Object.keys(LCD.state.setup.options);
                    index = options.indexOf(LCD.state.setup.selection) + 1;
